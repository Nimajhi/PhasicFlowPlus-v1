...
public:
    ...
    Foam::scalar dimlessDrag(Foam::scalar Re, Foam::scalar ep) const
    {
        ...
        const Foam::scalar Re4 = Re2*Re2;

        const Foam::scalar K2 =
            (1.0 + 0.130*Rec + 6.66e-4*Re2)
            /(1.0 + 3.42e-2*Rec + 6.92e-6*Re2);

        const Foam::scalar K3n = -410.0*epc + 9.20e-7*Rec*Foam::sqr(K0)
            + 1900.0*ep3 - 6.60e-2*Re4;

        const Foam::scalar K3d = 6600.0*epc + 4.92e-4*Re4 - 4.30e4*ep2
